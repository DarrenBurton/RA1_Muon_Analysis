...
tree,value1,l = MakeMuonDataTree(86.)
treeMC,value2,j = MakeMuonMCTree(86.)
cutTreeData,value3,k = MakeHadDataTree(86.)
cutTreeMC,value4,m = MakeHadMCTree(86.)
...
Muon_Analysis=Analysis("Muon_325")
addCutFlowMuon(Muon_Analysis)

Muon_MC=Analysis("MuonMC_325")
addCutFlowMuonMC(Muon_MC)

Had_Analysis=Analysis("Had_325")
addCutFlowHadData(Had_Analysis)

Had_MC=Analysis("HadMC_325")
