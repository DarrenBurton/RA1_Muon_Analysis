...
def AddBinedHist(cutTree = None, OP = (), cut = None, htBins = [], data = None):
  ...
  if len(htBins)>2:  alphat = [0.55,None]
  if htBins[0] == 275: alphat = [0.55,None]
  if htBins[0] == 325: alphat = [0.55,None]
...
def MakeMuonMCTree(Threshold):
  ...
  treeMC.TAttach(selection,GE2Jets)
...
def MakeHadDataTree(Threshold):
  ...
  cutTreeData.TAttach(json,selection)
  cutTreeData.TAttach(selection, HBHE)
  cutTreeData.TAttach(HBHE,GE2Jets)
  cutTreeData.TAttach(GE2Jets, secondJetET)
  cutTreeData.TAttach(secondJetET,LeadingJetEta)
  cutTreeData.TAttach(LeadingJetEta,ZeroElectrons)
  cutTreeData.TAttach(ZeroElectrons,ZeroMuons)
  cutTreeData.TAttach(ZeroMuons,ZeroPhotons)
  cutTreeData.TAttach(ZeroPhotons,oddMuon)
  cutTreeData.TAttach(oddMuon,oddJet)
  cutTreeData.TAttach(oddJet,oddPhoton)
  cutTreeData.TAttach(oddPhoton,oddElec)
  cutTreeData.TAttach(oddElec,badMuonInJet)
  cutTreeData.TAttach(badMuonInJet,DeadECAL_Data)
  cutTreeData.TAttach(DeadECAL_Data,VertexPtOverHT)
  cutTreeData.TAttach(VertexPtOverHT,recHitCut)
  cutTreeData.TAttach(recHitCut, MHToverMET)
...
def MakeHadMCTree(Threshold):
  ...
  cutTreeMC.TAttach(selection,HBHE)
  cutTreeMC.TAttach(HBHE,GE2Jets)
  cutTreeMC.TAttach(GE2Jets,secondJetET)
  cutTreeMC.TAttach(secondJetET,LeadingJetEta)
  cutTreeMC.TAttach(LeadingJetEta,ZeroElectrons)
  cutTreeMC.TAttach(ZeroElectrons,ZeroMuons)
  cutTreeMC.TAttach(ZeroMuons,ZeroPhotons)
  cutTreeMC.TAttach(ZeroPhotons,oddMuon)
  cutTreeMC.TAttach(oddMuon,oddJet)
  cutTreeMC.TAttach(oddJet,oddPhoton)
  cutTreeMC.TAttach(oddPhoton,oddElec)
  cutTreeMC.TAttach(oddElec,badMuonInJet)
  cutTreeMC.TAttach(badMuonInJet,DeadECAL_MC)
  cutTreeMC.TAttach(DeadECAL_MC,VertexPtOverHT)
  cutTreeMC.TAttach(VertexPtOverHT,recHitCut)
  cutTreeMC.TAttach(recHitCut,MHToverMET) 
