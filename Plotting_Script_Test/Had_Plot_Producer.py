...
settings = {
  ...
  "Plots":["BiasedDeltaPhi_after_alphaT_55_all","AlphaT_all","AlphaT_Zoomed_all","HT_all","HT_after_alphaT_55_all","HT_after_alphaT_52_all","HT_after_alphaT_53_all",   "Btag_Pre_AlphaT_4__all","Btag_Pre_AlphaT_5__all","Btag_Post_AlphaT_4_55_all","Btag_Post_AlphaT_5_55_all","EffectiveMass_all","EffectiveMass_after_alphaT_55_all","EffectiveMass_after_alphaT_53_all","EffectiveMass_after_alphaT_52_all", "JetMultiplicity_all","JetMultiplicityAfterAlphaT_55_all","JetMultiplicityAfterAlphaT_53_all","JetMultiplicityAfterAlphaT_52_all","Number_Primary_verticies_after_alphaT_55_all","Number_Primary_verticies_after_alphaT_53_all","MHT_all"],
  "Lumo" : 46.5,
  "Webpage":"btag",
  "Category":"",
...
if __name__=="__main__":
  a = Plotter(settings,muon_plots)
  b = Plotter(settings,muon_morethanzero_btag_plots)
  c = Plotter(settings,muon_two_btag_plots)
  d = Plotter(settings,muon_zero_btag_plots)
