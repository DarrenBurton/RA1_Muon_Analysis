...
muon_one_btag_plots = {
     ...
     "mcb6":("./PLOT_ROOT_FILES/Muon_SingT.root","btag_one_DiMuon_","Single_Top","DiMuon","One"),
...
muon_two_btag_plots = {
     ...
     "mcb6":("./PLOT_ROOT_FILES/Muon_SingT.root","btag_two_DiMuon_","Single_Top","DiMuon","Two"),
...
muon_zero_btag_plots = {
     ...
     "mcb6":("./PLOT_ROOT_FILES/Muon_SingT.root","btag_zero_DiMuon_","Single_Top","DiMuon","Zero"),
...
if __name__=="__main__":
  ...
  #b = Plotter(settings,muon_one_btag_plots)
  #c = Plotter(settings,muon_two_btag_plots)
  d = Plotter(settings,muon_morethanzero_btag_plots)
