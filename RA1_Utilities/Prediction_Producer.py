...
if __name__=="__main__":
  ...
  #d = Number_Extractor(settings,btag_more_than_two_samples,"More_Than_Two_btags",Triggers = "True",AlphaT="False",Calculation=calc_file)
  #t = Number_Extractor(settings,btag_zero_samples,"Zero_btags",Triggers = "True",AlphaT="True",Calculation=calc_file)
  #e  = Number_Extractor(settings,btag_more_than_zero_samples,"More_Than_Zero_btags",Triggers = "True",AlphaT="False",Calculation=calc_file)
  #f  = Number_Extractor(settings,btag_more_than_one_samples,"More_Than_One_btags",Triggers = "True",AlphaT="False",Calculation=calc_file)
  #g  = Number_Extractor(settings,inclusive_samples,"Inclusive",Triggers = "True",AlphaT="True",Calculation=calc_file)
