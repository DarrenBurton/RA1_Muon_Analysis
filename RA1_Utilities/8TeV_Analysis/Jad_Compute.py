...
class Jad_Compute(object):
  ...
  def MakeVectors(self,dict_list):
    ...
    if self.Classic == "True" :
      ...
      test_3 = {'MCS' : [], 'MCSE': [],'MCC': [], 'MCCE':[],'DC':[],'DS':[],'option' : -2.,'box' : "False",'plot_title':"#mu + jets (no #alpha_{T}) #rightarrow #mu + jets (#alpha_{T}>0.55)",'scale':None , 'reduce':"True", 'file_name':'Btag_mu_to_mu_with_without_alphaT','spread':"False" } 
