...
samples = {
    "nMuon":("./High_Stat_Root_Files/Muon_Data","OneMuon_","Data","Muon"),
    
    #Muon MC
     #"mcMuonW1":("./High_Stat_Root_Files/Muon_WJetsInc","OneMuon_","WJetsInc","Muon"),
     "mcMuonW2":("./High_Stat_Root_Files/Muon_WJets250","OneMuon_","WJets250","Muon"),
     "mcMuonW3":("./High_Stat_Root_Files/Muon_WJets300","OneMuon_","WJets300","Muon"),
     "mcMuonTtw":("./High_Stat_Root_Files/Muon_TTbar","OneMuon_","TTbar","Muon"),
     "mcMuonZ1":("./High_Stat_Root_Files/Muon_Zinv50","OneMuon_","Zinv50","Muon"),
     "mcMuonZ2":("./High_Stat_Root_Files/Muon_Zinv100","OneMuon_","Zinv100","Muon"),
     "mcMuonZ3":("./High_Stat_Root_Files/Muon_Zinv200","OneMuon_","Zinv200","Muon"),
     "mcMuonDY":("./High_Stat_Root_Files/Muon_DY","OneMuon_","DY","Muon"),
     "mcMuon_Singt":("./High_Stat_Root_Files/Muon_Single_T_t","OneMuon_","Single_T_t","Muon"),
     "mcMuon_SingtW":("./High_Stat_Root_Files/Muon_Single_T_tW","OneMuon_","Single_T_tW","Muon"),
     "mcMuon_Singtbar_t":("./High_Stat_Root_Files/Muon_Single_Tbar_t","OneMuon_","Single_Tbar_t","Muon"),
     "mcMuon_Singtbar_tw":("./High_Stat_Root_Files/Muon_Single_Tbar_tW","OneMuon_","Single_Tbar_tW","Muon"),
     "mcMuonZZ":("./High_Stat_Root_Files/Muon_ZZ","OneMuon_","ZZ","Muon"),
     "mcMuonWW":("./High_Stat_Root_Files/Muon_WW","OneMuon_","WW","Muon"),
     "mcMuonWZ":("./High_Stat_Root_Files/Muon_WZ","OneMuon_","WZ","Muon"),

    "nDimuon":("./High_Stat_Root_Files/Muon_Data","DiMuon_","Data","DiMuon"),
    
    #Muon MC
     #"mcDimuonW1":("./High_Stat_Root_Files/Muon_WJetsInc","DiMuon_","WJetsInc","DiMuon"),
     "mcDimuonW2":("./High_Stat_Root_Files/Muon_WJets250","DiMuon_","WJets250","DiMuon"),
     "mcDimuonW3":("./High_Stat_Root_Files/Muon_WJets300","DiMuon_","WJets300","DiMuon"),
     "mcDimuonTtw":("./High_Stat_Root_Files/Muon_TTbar","DiMuon_","TTbar","DiMuon"),
     "mcDimuonZ1":("./High_Stat_Root_Files/Muon_Zinv50","DiMuon_","Zinv50","DiMuon"),
     "mcDimuonZ2":("./High_Stat_Root_Files/Muon_Zinv100","DiMuon_","Zinv100","DiMuon"),
     "mcDimuonZ3":("./High_Stat_Root_Files/Muon_Zinv200","DiMuon_","Zinv200","DiMuon"),
     "mcDimuonDY":("./High_Stat_Root_Files/Muon_DY","DiMuon_","DY","DiMuon"),
     "mcDimuon_Singt":("./High_Stat_Root_Files/Muon_Single_T_t","DiMuon_","Single_T_t","DiMuon"),
     "mcDimuon_SingtW":("./High_Stat_Root_Files/Muon_Single_T_tW","DiMuon_","Single_T_tW","DiMuon"),
     "mcDimuon_Singtbar_t":("./High_Stat_Root_Files/Muon_Single_Tbar_t","DiMuon_","Single_Tbar_t","DiMuon"),
     "mcDimuon_Singtbar_tw":("./High_Stat_Root_Files/Muon_Single_Tbar_tW","DiMuon_","Single_Tbar_tW","DiMuon"),
     "mcDimuonZZ":("./High_Stat_Root_Files/Muon_ZZ","DiMuon_","ZZ","DiMuon"),
     "mcDimuonWW":("./High_Stat_Root_Files/Muon_WW","DiMuon_","WW","DiMuon"),
     "mcDimuonWZ":("./High_Stat_Root_Files/Muon_WZ","DiMuon_","WZ","DiMuon"),
...
if __name__=="__main__":
  LIST_FOR_JAD = []
  a = Number_Extractor(settings,btag_zero_samples,"Zero_btags",c_file = LIST_FOR_JAD,Closure = "True",AlphaT="True",Triggers="True") 
  #b = Number_Extractor(settings,btag_one_samples,"One_btag",c_file = LIST_FOR_JAD,Closure="True",AlphaT="True",Triggers="True")
  #c = Number_Extractor(settings,btag_two_samples,"Two_btags",c_file = LIST_FOR_JAD,Closure="True",AlphaT="True",Triggers="True")
  d = Number_Extractor(settings,samples,"BaseLine",c_file = LIST_FOR_JAD,Closure="True",AlphaT="True",Triggers="True")
