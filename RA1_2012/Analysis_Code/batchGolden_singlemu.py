...
def MakeDataTree(Threshold,Muon = None,Split = None):
  ...
  if int(Threshold) in [73,86]:  Leading_MuPtCut = OP_LowerMuPtCut(45)
  else: Leading_MuPtCut = OP_LowerMuPtCut(50)
  ...
  if Muon == None:
      ...
      htBins = HTBins,TriggerDict = single_triggers,lab = "OneMuon_") )
      ...
      htBins = HTBins,TriggerDict = single_triggers,lab = "DiMuon_") )
...
def MakeMCTree(Threshold, Muon = None,Split = None):
  ...
  if int(Threshold) in [73,86]:  Leading_MuPtCut = OP_UpperMuPtCut(45.)
  else: Leading_MuPtCut = OP_UpperMuPtCut(50.)
  #Leading_MuPtCut = OP_UpperMuPtCut(50.)
  secondJetET = OP_SecondJetEtCut(Threshold)
  cutTreeMC = Tree("MC")
