...
if __name__=="__main__":
  ...
  e = Number_Extractor(settings,btag_morethan_one_samples,"More_Than_One_btag",c_file = LIST_FOR_JAD,Closure="True",AlphaT="True",Triggers="True")
  f = Number_Extractor(settings,btag_morethan_two_samples,"More_Than_Two_btag",c_file = LIST_FOR_JAD,Closure="True",AlphaT="True",Triggers="True")
  g = Number_Extractor(settings,btag_morethan_zero_samples,"More_Than_Zero_btag",c_file = LIST_FOR_JAD,Closure="True",AlphaT="True",Triggers="True")
