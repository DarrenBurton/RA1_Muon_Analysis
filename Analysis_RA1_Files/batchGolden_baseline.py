...
def MakeDataTree(Threshold,Muon = None,Split = None):
  ...
  if Muon == None:
      ...
      OP = ("WeeklyUpdatePlots",genericPSet), cut = zerobtag,
      htBins = HTBins,TriggerDict = triggers,lab ="btag_zero_") )

      out.append(AddBinedHist(cutTree = cutTreeData,
      OP = ("WeeklyUpdatePlots",genericPSet), cut = more_than_zero_btag,
      htBins = HTBins,TriggerDict = triggers,lab ="btag_morethanzero_") )

      out.append(AddBinedHist(cutTree = cutTreeData,
      OP = ("WeeklyUpdatePlots",genericPSet), cut = onebtag,
      htBins = HTBins,TriggerDict = triggers,lab ="btag_one_") )

      out.append(AddBinedHist(cutTree = cutTreeData,
      OP = ("WeeklyUpdatePlots",genericPSet), cut = more_than_one_btag,
      htBins = HTBins,TriggerDict = triggers,lab ="btag_morethanone_") )

      out.append(AddBinedHist(cutTree = cutTreeData,
      OP = ("WeeklyUpdatePlots",genericPSet), cut = twobtag,
      htBins = HTBins,TriggerDict = triggers,lab ="btag_two_") )

      out.append(AddBinedHist(cutTree = cutTreeData,
      OP = ("WeeklyUpdatePlots",genericPSet), cut = more_than_two_btag,
      ...
      if int(Threshold) is 73 or int(Threshold) is 86 :
        ...
        out.append(AddBinedHist(cutTree = cutTreeData,
        OP = ("WeeklyUpdatePlots",genericPSet), cut = zerobtagOneMuon,
        htBins = HTBins,TriggerDict = triggers ,lab ="btag_zero_OneMuon_") )

        out.append(AddBinedHist(cutTree = cutTreeData,
        OP = ("WeeklyUpdatePlots",genericPSet), cut = more_than_zero_btagOneMuon,
        htBins = HTBins,TriggerDict = triggers ,lab ="btag_morethanzero_OneMuon_") )

        out.append(AddBinedHist(cutTree = cutTreeData,
        OP = ("WeeklyUpdatePlots",genericPSet), cut = onebtagOneMuon,
        htBins = HTBins,TriggerDict = triggers ,lab ="btag_one_OneMuon_") )

        out.append(AddBinedHist(cutTree = cutTreeData,
        OP = ("WeeklyUpdatePlots",genericPSet), cut = more_than_one_btagOneMuon,
        htBins = HTBins,TriggerDict = triggers ,lab ="btag_morethanone_OneMuon_") )

        out.append(AddBinedHist(cutTree = cutTreeData,
        OP = ("WeeklyUpdatePlots",genericPSet), cut = twobtagOneMuon,
        htBins = HTBins,TriggerDict = triggers ,lab ="btag_two_OneMuon_") )

        out.append(AddBinedHist(cutTree = cutTreeData,
        OP = ("WeeklyUpdatePlots",genericPSet), cut = more_than_two_btagOneMuon,
      ...
      if int(Threshold) is 73 or int(Threshold) is 86 :
        ...
        out.append(AddBinedHist(cutTree = cutTreeData,
        OP = ("WeeklyUpdatePlots",genericPSet), cut = zerobtagDiMuon,
        htBins = HTBins,TriggerDict = triggers,lab ="btag_zero_DiMuon_") )

        out.append(AddBinedHist(cutTree = cutTreeData,
        OP = ("WeeklyUpdatePlots",genericPSet), cut = more_than_zero_btagDiMuon,
        htBins = HTBins,TriggerDict = triggers,lab ="btag_morethanzero_DiMuon_") )

        out.append(AddBinedHist(cutTree = cutTreeData,
        OP = ("WeeklyUpdatePlots",genericPSet), cut = onebtagDiMuon,
        htBins = HTBins,TriggerDict = triggers,lab ="btag_one_DiMuon_") )
     
        out.append(AddBinedHist(cutTree = cutTreeData,
        OP = ("WeeklyUpdatePlots",genericPSet), cut = more_than_one_btagDiMuon,
        htBins = HTBins,TriggerDict = triggers,lab ="btag_morethanone_DiMuon_") )
     
        out.append(AddBinedHist(cutTree = cutTreeData,
        OP = ("WeeklyUpdatePlots",genericPSet), cut = twobtagDiMuon,
        htBins = HTBins,TriggerDict = triggers,lab ="btag_two_DiMuon_") )
     
        out.append(AddBinedHist(cutTree = cutTreeData,
        OP = ("WeeklyUpdatePlots",genericPSet), cut = more_than_two_btagDiMuon,
