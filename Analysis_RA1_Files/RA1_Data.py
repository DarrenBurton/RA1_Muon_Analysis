...
#cutTree,blah,l = MakeDataTree(100., Muon = None,Split="Had_One")
...
#outdir = "../RA2B_"+strftime("%d_%b")+"/Data/"
outdir = "../results_"+strftime("%d_%b")+"/Data/"

#outdir = "../Split_Jsons_"+strftime("%d_%b")+"/Data/"

ensure_dir(outdir)

anal_ak5_caloData.Run(outdir,conf_ak5_caloData,[HT_L1OffSet])#HT_Run2011A])
#anal_ak5_caloData.Run(outdir,conf_ak5_caloData,[CMSSM_Skim])#HT_Run2011A])
