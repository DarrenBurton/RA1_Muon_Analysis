...
cutTree,blah,l = MakeDataTree(100., Muon = True,Split = "Muon_Two")
cutBtagTree,blam,m = MakeBtagDataTree(100., Muon = True,Split = "Muon_Two")
...
#outdir = "../results_"+strftime("%d_%b")+"//MuonData_2/"
...
anal_ak5_caloData.Run(outdir,conf_ak5_caloData,[HT_L1OffSet])
